...
def filtering(item3, user_baskets, offered_course_list):
    user_prev_items = []
    ...
    #     if item8 in item_list:
    #         offered_course_list_new.append(item8)
    
    # if item3 in user_prev_items or item3 not in offered_course_list_new:
    #     return True
    if item3 in user_prev_items or item3 not in offered_course_list:
        return True
    else:
        return False
